...
assert.match(privacy, /Session replay records puzzle interactions/);
assert.match(privacy, /page views, clicks, scrolls, heatmaps, dead clicks, performance metrics, errors, and console messages/);
assert.match(privacy, /surveys and feature flags/);
assert.match(privacy, /imported screenshot preview remains excluded from replay/);
assert.match(privacy, /custom events do not attach screenshots or raw puzzle contents/);
assert.match(privacy, /may buffer or retry delivery/);
